...
import { PlusCircle, PencilIcon, TrashIcon, LinkIcon, Loader2 } from "lucide-react"
    ...
    <div className="space-y-6 w-full max-w-3xl mx-auto">
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            {editingTitle ? (
              <Input
                ...
                onKeyDown={(e) => e.key === "Enter" && updateSurveyTitle(e.target.value)}
          ...
          {editingDescription ? (
            ...
            >
              {survey.description || "Add a description..."} <PencilIcon className="inline ml-1 h-3 w-3" />
            </CardDescription>
          )}
        </CardHeader>
      </Card>
                ...
                <Select
                  ...
                  onValueChange={(value: QuestionType) => 
                    updateQuestion(question.id, { 
                      type: value,
                      options: value === 'radio' || value === 'checkbox' 
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>This is how participants will see your survey</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
