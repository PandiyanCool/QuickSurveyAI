      ...
      <CardContent>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="text-sm font-medium">{survey.questions.length} questions</span>
            <span className="text-sm text-muted-foreground">•</span>
            <span className="text-sm font-medium">{survey.responses} responses</span>
          </div>
        </div>
      </CardContent>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This will permanently delete the survey "{survey.title}" and all its responses.
